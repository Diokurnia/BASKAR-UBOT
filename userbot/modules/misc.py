...
async def killdabot(event):
    ...
    await event.edit("`Menonaktifkan BASKAR-UBOT....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`BASKAR-UBOT Telah Dinonaktifkan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting BASKAR-UBOT...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`BASKAR-UBOT Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[BASKAR-UBOT Repo](https://github.com/Diokurnia/BASKAR-UBOT/blob/BASKAR-UBOT/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        f"**╭✠╼━━━━━━❖━━━━━━━✠╮**\n             [{REPO_NAME}](https://github.com/Diokurnia/BASKAR-UBOT)\n╰✠╼━━━━━━❖━━━━━━━✠╯\n•PEMILIK         : [𝐎𝐖𝐍𝐄𝐑]({OWNER_BOT})\n•CHANNEL      : [𝐈𝐍𝐅𝐎](t.me/BaskarProject)\n•GROUP           : [𝐆𝐑𝐎𝐔𝐏]({GROUP_LINK})\n•INSTAGRAM  :  [𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌]({IG_ALIVE})"
    )
