...
# Credits @keselekpermen69 / @Ultroid / @BASKAR-UBOT
# Ported @baskarnie / JANGAN DI APUS BABI
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/Diokurnia/BASKAR-UBOT")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "BASKAR-UBOT")
...
# Untuk Melihat Repo
REPO_NAME = os.environ.get("REPO_NAME") or "🦡𝗕𝗔𝗦𝗞𝗔𝗥-𝗨𝗕𝗢𝗧🦡"
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "BASKAR-UBOT")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/9350ac1ed1a8fda106b02.jpg"

# Default .helpme logo
HELP_LOGO = os.environ.get(
   "HELP_LOGO") or "https://telegra.ph/file/177bdf0c2d9c2205e996b.jpg"

# Default .alive Instagram
IG_ALIVE = os.environ.get("IG_ALIVE") or "instagram.com/dio_krna"
...
GROUP_LINK = os.environ.get(
    "GROUP_LINK") or "t.me/BaskarSupportGroup"

# Default .repo Bot
OWNER_BOT = os.environ.get(
    "OWNER_BOT") or "t.me/baskarnie"


# Last.fm Module
BIO_PREFIX = os.environ.get("BIO_PREFIX", None)
DEFAULT_BIO = os.environ.get("DEFAULT_BIO") or "🦡𝗕𝗔𝗦𝗞𝗔𝗥-𝗨𝗕𝗢𝗧🦡"
...
BOTLOG_MSG = os.environ.get(
    "BOTLOG_MSG") or "```║DAH AKTIF YA ANAK HARAM🔥🔥║\n\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\nJika Tidak Bisa Di .ping\nSilahkan Anda\nCek viewlogs\nPada heroku Anda.\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰```"
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                ...
                await event.reply(
                    f"HAI WELCOME [{get_display_name(u)}](tg://user?id={u.id}) TEMPAT DIMANA ANDA BISA MENGELUARKAN KELUH KESAH MU\n**BISA JUGA REQ KATA" SESUKA MU**\nOKE TERIMAKASIH JANGAN CANGGUNG BUAT ISI KATA" JANGAN LUPA JOIN KE \n**𝗚𝗥𝗢𝗨𝗣 𝗦𝗨𝗣𝗣𝗢𝗥𝗧** Dibawah Ini.\n",
                    buttons=[
                        [
                             Button.url(f"{EMOJI_HELP} 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 {EMOJI_HELP}",
                                        "t.me/BaskarProject"),
                             Button.url(f"{EMOJI_HELP} 𝗚𝗥𝗢𝗨𝗣 𝗦𝗨𝗣𝗣𝗢𝗥𝗧 {EMOJI_HELP}",
                                        "t.me/BaskarSupportGroup")],
